^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package my_ur5_moveit_config
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
* remove old my_ur5_moveit_config
...
* Removed ur5_joint_limited_moveit_config.  my_ur5_moveit_config now has limited joint ranges to plus/minus 180 degrees.
