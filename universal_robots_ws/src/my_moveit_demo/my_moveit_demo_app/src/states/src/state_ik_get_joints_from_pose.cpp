...
state_ik_get_joints_from_pose::state_ik_get_joints_from_pose(const std::string& state_object_name, const std::string& group, bool ignore_orientation/* define own paramters here*/)
: node_handle("")
{
