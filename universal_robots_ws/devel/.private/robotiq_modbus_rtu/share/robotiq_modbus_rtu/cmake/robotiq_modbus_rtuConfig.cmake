...
if("TRUE" STREQUAL "TRUE")
  set(robotiq_modbus_rtu_SOURCE_PREFIX /home/student/LJ2_P4_ROS_Groep1/universal_robots_ws/src/my_universal_robots/robotiq/robotiq_modbus_rtu)
  set(robotiq_modbus_rtu_DEVEL_PREFIX /home/student/LJ2_P4_ROS_Groep1/universal_robots_ws/devel/.private/robotiq_modbus_rtu)
  ...
  set(robotiq_modbus_rtu_INSTALL_PREFIX /home/student/LJ2_P4_ROS_Groep1/universal_robots_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'robotiq_modbus_rtu' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'robotiq_modbus_rtu' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/student/LJ2_P4_ROS_Groep1/universal_robots_ws/src/my_universal_robots/robotiq/robotiq_modbus_rtu/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT robotiq_modbus_rtu_NUM_DUMMY_TARGETS)
      set(robotiq_modbus_rtu_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::robotiq_modbus_rtu::wrapped-linker-option${robotiq_modbus_rtu_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR robotiq_modbus_rtu_NUM_DUMMY_TARGETS "${robotiq_modbus_rtu_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::robotiq_modbus_rtu::wrapped-linker-option${robotiq_modbus_rtu_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND robotiq_modbus_rtu_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/student/LJ2_P4_ROS_Groep1/universal_robots_ws/devel/.private/robotiq_modbus_rtu/lib;/home/student/LJ2_P4_ROS_Groep1/universal_robots_ws/devel/lib;/home/student/universal_robots_ws/devel/lib;/home/student/rospackages_ws/devel/lib;/opt/ros/melodic/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${robotiq_modbus_rtu_dep}_FOUND)
      find_package(${robotiq_modbus_rtu_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${robotiq_modbus_rtu_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
