...
(cl:ensure-generic-function 'buttontype-val :lambda-list '(m))
(cl:defmethod buttontype-val ((m <HMI_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hmi-msg:buttontype-val is deprecated.  Use hmi-msg:buttontype instead.")
  (buttontype m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <HMI_state>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'buttontype)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <HMI_state>) istream)
  "Deserializes a message object of type '<HMI_state>"
    ...
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'buttontype)) (cl:read-byte istream))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<HMI_state>)))
  ...
  "d05be62867557efe2359be0b2c4cb496")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'HMI_state)))
  "Returns md5sum for a message object of type 'HMI_state"
  "d05be62867557efe2359be0b2c4cb496")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<HMI_state>)))
  ...
  (cl:format cl:nil "string programstate~%string programtype~%uint8 buttontype~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'HMI_state)))
  "Returns full string definition for message of type 'HMI_state"
  (cl:format cl:nil "string programstate~%string programtype~%uint8 buttontype~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <HMI_state>))
  ...
  (cl:list 'HMI_state
    ...
    (cl:cons ':buttontype (buttontype msg))
))
