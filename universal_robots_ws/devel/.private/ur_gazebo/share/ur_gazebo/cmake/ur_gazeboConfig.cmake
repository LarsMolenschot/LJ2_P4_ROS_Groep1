...
if("TRUE" STREQUAL "TRUE")
  set(ur_gazebo_SOURCE_PREFIX /home/student/LJ2_P4_ROS_Groep1/universal_robots_ws/src/universal_robot/ur_gazebo)
  set(ur_gazebo_DEVEL_PREFIX /home/student/LJ2_P4_ROS_Groep1/universal_robots_ws/devel/.private/ur_gazebo)
  ...
  set(ur_gazebo_INSTALL_PREFIX /home/student/LJ2_P4_ROS_Groep1/universal_robots_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ur_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/student/LJ2_P4_ROS_Groep1/universal_robots_ws/src/universal_robot/ur_gazebo/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT ur_gazebo_NUM_DUMMY_TARGETS)
      set(ur_gazebo_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ur_gazebo::wrapped-linker-option${ur_gazebo_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ur_gazebo_NUM_DUMMY_TARGETS "${ur_gazebo_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ur_gazebo::wrapped-linker-option${ur_gazebo_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ur_gazebo_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/student/LJ2_P4_ROS_Groep1/universal_robots_ws/devel/.private/ur_gazebo/lib;/home/student/LJ2_P4_ROS_Groep1/universal_robots_ws/devel/lib;/home/student/universal_robots_ws/devel/lib;/home/student/rospackages_ws/devel/lib;/opt/ros/melodic/lib)
