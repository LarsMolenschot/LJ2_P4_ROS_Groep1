...
if(NOT "/home/student/LJ2_P4_ROS_Groep1/universal_robots_ws/src/Universal_Robots_ROS_Driver/ur_robot_driver/include;/usr/include;/home/student/LJ2_P4_ROS_Groep1/universal_robots_ws/devel/include " STREQUAL " ")
  set(ur_robot_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/student/LJ2_P4_ROS_Groep1/universal_robots_ws/src/Universal_Robots_ROS_Driver/ur_robot_driver/include;/usr/include;/home/student/LJ2_P4_ROS_Groep1/universal_robots_ws/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ur_robot_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/student/LJ2_P4_ROS_Groep1/universal_robots_ws/src/Universal_Robots_ROS_Driver/ur_robot_driver/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT ur_robot_driver_NUM_DUMMY_TARGETS)
      set(ur_robot_driver_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ur_robot_driver::wrapped-linker-option${ur_robot_driver_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ur_robot_driver_NUM_DUMMY_TARGETS "${ur_robot_driver_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ur_robot_driver::wrapped-linker-option${ur_robot_driver_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ur_robot_driver_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/student/LJ2_P4_ROS_Groep1/universal_robots_ws/devel/.private/ur_robot_driver/lib;/home/student/LJ2_P4_ROS_Groep1/universal_robots_ws/devel/lib;/home/student/universal_robots_ws/devel/lib;/home/student/rospackages_ws/devel/lib;/opt/ros/melodic/lib)
...
set(depends "actionlib;controller_manager;control_msgs;geometry_msgs;hardware_interface;kdl_parser;pass_through_controllers;pluginlib;roscpp;scaled_joint_trajectory_controller;sensor_msgs;speed_scaling_interface;speed_scaling_state_controller;std_srvs;tf;tf2_geometry_msgs;tf2_msgs;trajectory_msgs;ur_dashboard_msgs;ur_msgs")
